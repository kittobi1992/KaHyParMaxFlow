...
In each step, the \emph{FM} algorihm moves a node with maximum \emph{gain} 
from its current block to an other block according to an objective
...
can be also applied to general flow networks. Our experiments indicates
...
\emph{Max-Flow-Min-Cut} computations improves a balanced $k$-way partition. \\
