...
\path[draw=drawColor,line width= 0.6pt,line join=round,line cap=round,fill=fillColor] (135.30, 12.80) rectangle (149.53, 27.03);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (397.48,325.21);
\definecolor[named]{fillColor}{rgb}{0.97,0.46,0.43}

\path[fill=fillColor] (136.02, 13.52) rectangle (148.82, 26.32);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (397.48,325.21);
\definecolor[named]{drawColor}{rgb}{1.00,1.00,1.00}
...
\path[draw=drawColor,line width= 0.6pt,line join=round,line cap=round,fill=fillColor] (236.45, 12.80) rectangle (250.67, 27.03);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (397.48,325.21);
\definecolor[named]{fillColor}{rgb}{0.00,0.75,0.77}

\path[fill=fillColor] (237.16, 13.52) rectangle (249.96, 26.32);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (397.48,325.21);
\definecolor[named]{drawColor}{rgb}{0.00,0.00,0.00}

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.82] at (151.34, 17.08) {Number of Nodes};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (397.48,325.21);
\definecolor[named]{drawColor}{rgb}{0.00,0.00,0.00}

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.82] at (252.48, 17.08) {Number of Edges};
\end{scope}
\end{tikzpicture}
