...
in block $V_2$ as sinks ($V''$ is defined in Defintion \ref{def:sub_extension}). More formally:
\begin{align*}
S' = V'' \cap V_1 \\
T' = V'' \cap V_2 
\end{align*}
...
with
\begin{align*}
S = \overbrace{S' \setminus V''}^{= \emptyset}\ \cup \bigcup\limits_{e \in I(\underbrace{\scriptstyle V'' \cap S'}_{= V'' \cap V_1})} \{\incoming{e}\} = \bigcup\limits_{e \in I(V'' \cap V_1)} \{\incoming{e}\} = \{\incoming{e}\ |\ e \in I(V'' \cap V_1)\} \\
T = \overbrace{T' \setminus V''}^{= \emptyset}\ \cup \bigcup\limits_{e \in I(\underbrace{\scriptstyle V'' \cap T'}_{= V'' \cap V_2})} \{\outgoing{e}\} = \bigcup\limits_{e \in I(V'' \cap V_2)} \{\outgoing{e}\} = \{\outgoing{e}\ |\ e \in I(V'' \cap V_2)\}
\end{align*}
...
\subparagraph{Implications for Graph Partitioning.}
\normalfont\normalsize
...
\subparagraph{Flow Execution Policies.}
\normalfont\normalsize
...
\subparagraph{Combining Flow-Based Refinements with the FM algorithm.}
\normalfont\normalsize
...
\subparagraph{Speedup Heuristics.}
\normalfont\normalsize
