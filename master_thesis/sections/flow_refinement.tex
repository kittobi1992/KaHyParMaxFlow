...
(see \autoref{img:section_hypergraph}).
...
$|f| = \omega_{\SectionHypergraph}(\Pi_2) = \omega_{H_{V'}}(\Pi_2)$ holds per Equation
...
$|f| = \omega_{\SectionHypergraph}(\Pi_2) = \omega_{H_{V'}}(\Pi_2)$, it holds that
$\Delta_H = \Delta_{H_{V'}}$. \\
...
\begin{theorem}
\label{theorem:ST}
The value of a maximum $(S,T)$-flow of $T_L(\SectionHypergraph)$ is equal with
