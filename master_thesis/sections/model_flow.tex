...
The structure we add between all \emph{incoming} and \emph{outgoing} edges is called 
...
into account means that \ShortT{G} performs significantly better on high density hypergraphs
