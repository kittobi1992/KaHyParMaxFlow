...
\EdmondKarp~is faster than \GoldbergTarjan~in most of different bechmark types. For
...
instead on $n$ as the \emph{FM} algorithm does. The running time
...
\PaToH{Q} ($1.9\%$) and \PaToH{D} ($1.4\%$). Since \KaHyPar{MF} build on top 
