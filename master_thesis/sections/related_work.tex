...
up to distance $D_t$. Also they maintain the invariant that $L = D_s + D_t + 1$ is an lower bound
...
\caption{Transformation of a hypergraph into the flow network \ShortT{L} \cite{lawler1973}. Note,
