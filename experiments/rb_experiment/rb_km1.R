...
twofm = ddply(dbGetQuery(dbConnect(SQLite(), dbname="rb_experiment/db/2fm_km1.db"),
                         select_cut_km1), c("graph","k"), aggreg)
twofm_kfm = ddply(dbGetQuery(dbConnect(SQLite(), dbname="rb_experiment/db/2fm_kfm_km1.db"),
                             select_cut_km1), c("graph","k"), aggreg)
twofm_kflow = ddply(dbGetQuery(dbConnect(SQLite(), dbname="rb_experiment/db/2fm_kflow_km1.db"),
                               select_cut_km1), c("graph","k"), aggreg)
kfm = ddply(dbGetQuery(dbConnect(SQLite(), dbname="rb_experiment/db/direct_kfm_km1.db"),
                       select_cut_km1), c("graph","k"), aggreg)
