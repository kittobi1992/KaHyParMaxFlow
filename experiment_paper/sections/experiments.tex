...
\begin{tabular}{r|*{2}{S[table-number-alignment = center,table-column-width=0.5cm]}
                  ...
                  *{2}{S[table-number-alignment = center,table-column-width=0.5cm]}
                       S[table-number-alignment = center]}
\toprule
 Config. & \multicolumn{3}{c|}{$\varepsilon = 1\%$} & \multicolumn{3}{c|}{$\varepsilon = 3\%$} & \multicolumn{3}{c}{$\varepsilon = 5\%$}\\
\midrule
...
\begin{tabular}{|r|S[table-number-alignment = center]|
                   ...
                   S[table-number-alignment = center]|}
\toprule
 & \multicolumn{3}{c|}{\textsc{M2} - \IBFS~with Multilevel Flow Execution Policy} \\
 \cmidrule{2-4}
